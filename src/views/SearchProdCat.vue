<template>
    <ion-page>
        <header class="grid">
            ...
            <div class="col-2">
                <ion-searchbar ref="searchRef" v-on:keyup.enter="SearchUsingEnter()" v-model="Search" class="searchshores" placeholder="Search products" show-clear-button="always"></ion-searchbar>
            </div>
            <div class="col-3">
            </div>
        </header>
            ...
            <div v-if="Status == true && Recent.length != 0">
                <ion-list>
                    ...
                    <div class="search-list">
                        <ion-card v-for="product of Products" v-bind:key="product" @click.prevent="GotoProduct(product.store_id, product.id)">
...
<script>
import { IonContent, IonPage, IonIcon, IonSearchbar, IonBackButton, IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle } from "@ionic/vue";
...
export default({
    ...
    methods: {
        ...
        LoadSearch() {
            ...
            axios.post(Global.methods.GetURL() + "/search_products", {
                search: this.Search,
