            ...
            <ion-content>
                <ion-list>
                    ...
                    <ion-menu-toggle auto-hide="false">
                        <ion-item button lines="none" router-link="/profile" v-if="UserID != ''">Profile</ion-item>
                    </ion-menu-toggle>
                    <ion-menu-toggle auto-hide="false">
                        <ion-item button lines="none" router-link="/orders" v-if="UserID != ''">Orders</ion-item>
                    </ion-menu-toggle>
                    <ion-menu-toggle auto-hide="false">
                        <ion-item button lines="none" router-link="/address" v-if="UserID != ''">Addresses</ion-item>
                    </ion-menu-toggle>
                    <ion-menu-toggle auto-hide="false">
...
<script>
import { IonApp, IonRouterOutlet, IonMenu, IonContent, IonList, IonListHeader, IonMenuToggle, IonItem, menuController, modalController } from "@ionic/vue";
